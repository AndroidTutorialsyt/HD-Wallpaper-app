...
public class LandActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("LAND WALLPAPERS");
    ...
    public void fetchWallpaper() {
        String url = "https://pixabay.com/api/?key=YOUR_API_KEY&q=Land&image_type=photo&pretty=true&page=" + pageNumber + "&per_page=80";
