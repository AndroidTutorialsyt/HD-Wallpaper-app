...
public class SunriseActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("SUNRISE WALLPAPERS");
    ...
    public void fetchWallpaper() {
        ...
        String url = "https://pixabay.com/api/?key=YOUR_API_KEY&q=sunrise&image_type=photo&pretty=true&page=" + pageNumber + "&per_page=80";
