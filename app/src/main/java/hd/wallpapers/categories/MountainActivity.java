...
public class MountainActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("MOUNTAINS WALLPAPERS");
    ...
    public void fetchWallpaper() {
        ...
        String url = "https://pixabay.com/api/?key=YOUR_API_KEY&q=Mountain&image_type=photo&pretty=true&page=" + pageNumber + "&per_page=80";
